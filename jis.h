...
#define UNI_DEFAULT_CODE      0x30fb
...
static const unsigned short to_uni_00[256] = {
  ...
  0x0080, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  ...
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xF8F1, 0xF8F2, 0xF8F3, 
};
...
static const unsigned short to_uni_85[256] = {
  ...
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0x30FB, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
...
static const unsigned short to_uni_F0[256] = {
  ...
  0xE038, 0xE039, 0xE03A, 0xE03B, 0xE03C, 0xE03D, 0xE03E, 0xFFFE, 
  ...
  0xE0B7, 0xE0B8, 0xE0B9, 0xE0BA, 0xE0BB, 0xFFFE, 0xFFFE, 0xFFFE, 
};
...
static const unsigned short to_uni_F1[256] = {
  ...
  0xE0F4, 0xE0F5, 0xE0F6, 0xE0F7, 0xE0F8, 0xE0F9, 0xE0FA, 0xFFFE, 
  ...
  0xE173, 0xE174, 0xE175, 0xE176, 0xE177, 0xFFFE, 0xFFFE, 0xFFFE, 
};
...
static const unsigned short to_uni_F2[256] = {
  ...
  0xE1B0, 0xE1B1, 0xE1B2, 0xE1B3, 0xE1B4, 0xE1B5, 0xE1B6, 0xFFFE, 
  ...
  0xE22F, 0xE230, 0xE231, 0xE232, 0xE233, 0xFFFE, 0xFFFE, 0xFFFE, 
};
...
static const unsigned short to_uni_F3[256] = {
  ...
  0xE26C, 0xE26D, 0xE26E, 0xE26F, 0xE270, 0xE271, 0xE272, 0xFFFE, 
  ...
  0xE2EB, 0xE2EC, 0xE2ED, 0xE2EE, 0xE2EF, 0xFFFE, 0xFFFE, 0xFFFE, 
};
...
static const unsigned short to_uni_F4[256] = {
  ...
  0xE328, 0xE329, 0xE32A, 0xE32B, 0xE32C, 0xE32D, 0xE32E, 0xFFFE, 
  ...
  0xE3A7, 0xE3A8, 0xE3A9, 0xE3AA, 0xE3AB, 0xFFFE, 0xFFFE, 0xFFFE, 
};
...
static const unsigned short to_uni_F5[256] = {
  ...
  0xE3E4, 0xE3E5, 0xE3E6, 0xE3E7, 0xE3E8, 0xE3E9, 0xE3EA, 0xFFFE, 
  ...
  0xE463, 0xE464, 0xE465, 0xE466, 0xE467, 0xFFFE, 0xFFFE, 0xFFFE, 
};
...
static const unsigned short to_uni_F6[256] = {
  ...
  0xE4A0, 0xE4A1, 0xE4A2, 0xE4A3, 0xE4A4, 0xE4A5, 0xE4A6, 0xFFFE, 
  ...
  0xE51F, 0xE520, 0xE521, 0xE522, 0xE523, 0xFFFE, 0xFFFE, 0xFFFE, 
};
...
static const unsigned short to_uni_F7[256] = {
  ...
  0xE55C, 0xE55D, 0xE55E, 0xE55F, 0xE560, 0xE561, 0xE562, 0xFFFE, 
  ...
  0xE5DB, 0xE5DC, 0xE5DD, 0xE5DE, 0xE5DF, 0xFFFE, 0xFFFE, 0xFFFE, 
};
...
static const unsigned short to_uni_F8[256] = {
  ...
  0xE618, 0xE619, 0xE61A, 0xE61B, 0xE61C, 0xE61D, 0xE61E, 0xFFFE, 
  ...
  0xE697, 0xE698, 0xE699, 0xE69A, 0xE69B, 0xFFFE, 0xFFFE, 0xFFFE, 
};
...
static const unsigned short to_uni_F9[256] = {
  ...
  0xE6D4, 0xE6D5, 0xE6D6, 0xE6D7, 0xE6D8, 0xE6D9, 0xE6DA, 0xFFFE, 
  ...
  0xE753, 0xE754, 0xE755, 0xE756, 0xE757, 0xFFFE, 0xFFFE, 0xFFFE, 
};
...
const unsigned short *to_uni[256] = {
  ...
  to_uni_F8, to_uni_F9, to_uni_FA, to_uni_FB, to_uni_FC, NULL, NULL, NULL, 
};
...
static const unsigned short from_uni_00[256] = {
  ...
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0x0021, 0x8191, 0x8192, 0xFFFE, 0x005C, 0x007C, 0x8198, 
  0x814E, 0x0063, 0x0061, 0x81E1, 0x81CA, 0x002D, 0x0052, 0x8150, 
  0x818B, 0x817D, 0x0032, 0x0033, 0x814C, 0x83CA, 0x81F7, 0x8145, 
  0x8143, 0x0031, 0x006F, 0x81E2, 0xFFFE, 0xFFFE, 0xFFFE, 0x003F, 
...
static const unsigned short from_uni_21[256] = {
  ...
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x8782, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0x8784, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  ...
  0x875C, 0x875D, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
...
static const unsigned short from_uni_22[256] = {
  ...
  0xFFFE, 0xFFFE, 0x81E3, 0xFFFE, 0xFFFE, 0x81E5, 0x8187, 0x8798, 
  0x81DA, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0x8161, 0xFFFE, 0x81C8, 
  0x81C9, 0x81BF, 0x81BE, 0x81E7, 0x81E8, 0xFFFE, 0x8793, 0xFFFE, 
...
static const unsigned short from_uni_30[256] = {
  ...
  0x82EE, 0x82EF, 0x82F0, 0x82F1, 0x8394, 0xFFFE, 0xFFFE, 0xFFFE, 
...
static const unsigned short from_uni_32[256] = {
  ...
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0x878A, 0x878B, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
...
static const unsigned short from_uni_F8[256] = {
  ...
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0x00A0, 0x00FD, 0x00FE, 0x00FF, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
};
...
static const unsigned short from_uni_FF[256] = {
  ...
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0x8191, 0x8192, 0x81CA, 0x8150, 0xFA55, 0x818F, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
  0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 0xFFFE, 
};
...
const unsigned short *from_uni[256] = {
  from_uni_00, NULL, NULL, from_uni_03, from_uni_04, NULL, NULL, NULL, 
  NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 
  NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 
  NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 
  from_uni_20, from_uni_21, from_uni_22, from_uni_23, from_uni_24, from_uni_25, from_uni_26, NULL, 
  NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 
  from_uni_30, NULL, from_uni_32, from_uni_33, NULL, NULL, NULL, NULL, 
  NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 
  NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 
  ...
  NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 
  NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 
  from_uni_F8, from_uni_F9, from_uni_FA, NULL, NULL, NULL, NULL, from_uni_FF, 
};
